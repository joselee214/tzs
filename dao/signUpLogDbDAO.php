<?php
class signUpLogDbDAO extends CachePKDbCrudDAO
{

    //表名
    protected $_table = 'sign_up_log';
    
    //数据库链接id
    protected $_dbindex = 0;

    //AR对象名
    //protected $_data_map = 'sign_up_log';
    
    protected $_pk = ['uid','pid'];   //主键
    ...
    */
    ...
    /** @return j7data_sign_up_log */
    public function _new($data=[])
    {
        $obj = new j7data_sign_up_log(get_called_class(),true);
        $obj->fromArray($data);
        return $obj;
    }
    ...
    */
    ...
    /** @return j7data_sign_up_log|null */
