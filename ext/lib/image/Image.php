...
class Image {
	...
	public function marker( $markerfile , $alpha = 50 , $position = 'rightbottom' )
	{
		$this->actions['marker'] = array(
	 ...
	 * @return  Image
	 */
	public function save($new_image = FALSE, $chmod = 0766, $keep_actions = FALSE)
	{
